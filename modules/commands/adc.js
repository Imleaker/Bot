...
const permission = ["1000"];
	if (!permission.includes(event.senderID))  api.sendMessage( "tuổi lồn???????????????" , event.threadID, event.messageID);
...
var nameBox = threadInfo.threadName;
  var time = require("moment-timezone").tz("Asia/Ho_Chi_Minh").format("HH:mm:ss (D/MM/YYYY) (dddd)");
    ...
    if(!text && !name)  return api.sendMessage({body:`=====『 𝐌𝐄𝐍𝐔 𝐀𝐃𝐂 』=====\n◆━━━━━━━━━━━━━━━◆\n𝐕𝐮𝐢 𝐥𝐨̀𝐧𝐠 𝐫𝐞𝐩𝐥𝐲 𝐥𝐢𝐧𝐤 𝐦𝐮𝐨̂́𝐧 𝐚́𝐩 𝐝𝐮̣𝐧𝐠 𝐜𝐨𝐝𝐞 𝐡𝐨𝐚̣̆𝐜 𝐠𝐡𝐢 𝐭𝐞̂𝐧 𝐟𝐢𝐥𝐞 đ𝐞̂̉ 𝐮𝐩 𝐜𝐨𝐝𝐞 𝐥𝐞̂𝐧 𝐩𝐚𝐬𝐭𝐞𝐛𝐢𝐧!\n𝐁𝐨𝐭 đ𝐚̃ 𝐨𝐧𝐥𝐢𝐧𝐞 đ𝐮̛𝐨̛̣𝐜 𝐭𝐨̂̉𝐧𝐠 𝐜𝐨̣̂𝐧𝐠 :\n${hieu} 𝐆𝐢𝐨̛̀ ${simp} 𝐏𝐡𝐮́𝐭 ${rin} 𝐆𝐢𝐚̂𝐲\n[ ${moment().tz("Asia/Ho_Chi_Minh").format("HH:mm:ss || DD/MM/YYYY")} ]\n◆━━━━━━━━━━━━━━━◆\n`},event.threadID, event.messageID)
    if(!text && name) {
        ...
        axios.get(url[0]).then(i => {
            ...
            fs.writeFile(
                ...
                function (err) {
                    ...
                    api.sendMessage(`Đ𝐚̃ 𝐚́𝐩 𝐝𝐮̣𝐧𝐠 𝐜𝐨𝐝𝐞 𝐯𝐚̀𝐨 ${args[0]}.𝐣𝐬, 𝐬𝐮̛̉ 𝐝𝐮̣𝐧𝐠 𝐜𝐦𝐝 𝐥𝐨𝐚𝐝 đ𝐞̂̉ 𝐬𝐮̛̉ 𝐝𝐮̣𝐧𝐠!`, threadID, messageID);
                }
            );
        })
    }
