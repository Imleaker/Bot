module.exports.config = {
    ...
    usages: "setspam/on/off [count] [time]",
    version: "1.0.0", 
    cooldowns: 0,
    ...
    switch(args[0]) {
        ...
        case "on":
            ...
            if (!antiSpamStatus[event.threadID]) {
                api.sendMessage("Vui lòng sử dụng 'antispam setspam [count] [time]", event.threadID);
                return;
            }
        ...
        case "off":
            ...
            break;
        default:
            api.sendMessage("Sử dụng antispam setspam/on/off [count] [time]", event.threadID);
    }
};